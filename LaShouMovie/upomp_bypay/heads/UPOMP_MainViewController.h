...
@interface UPOMP_MainViewController : UIViewController{
    ...
    IBOutlet UIImageView *naBarLogo;
    IBOutlet UIImageView *botLine;
    UPOMP *upomp;
    ...
    IBOutlet UIImageView *merchantNameRightBG;
    ...
    IBOutlet UIImageView *merchantAmtRightBG;
    ...
    IBOutlet UIImageView *merchantOrderIDRightBG;
    ...
    IBOutlet UIImageView *merchantOrderTimeRightBG;
    ...
    IBOutlet UIImageView *merchantOrderDescRightBG;
