...
@interface UPOMP_OrdinaryPasswordViewController : UPOMP_ViewController<UITableViewDataSource,UITableViewDelegate,UPOMP_KaNetDelegate>{//MoreButtonDelegate
    ...
    IBOutlet UIView *phoneNumLine;
    IBOutlet UIImageView *phoneNumIcon;
    
    IBOutlet UITableViewCell *secureInfoCell;
    IBOutlet UIImageView *secureInfoBG;
    IBOutlet UIImageView *secureInfoLeftBG;
    IBOutlet UILabel *secureInfoText;
    IBOutlet UILabel *secureInfoValue;
